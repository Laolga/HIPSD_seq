...
option_list <- list(
  ...
  make_option(c("-w", "--bin_kb"), type = "integer", default = 100, 
...
# path_ref="/home/o313a/olga/aurelie_data/reference/hmmcopy_references/cellranger_xy_"
# input_files = "../100k/cellranger/hmmcopy_pipe/metacell_files/10.txt"
# output_dir= "/home/o313a/olga/aurelie_data/100k/cellranger/hmmcopy_pipe/metacells_res/"
# create_bulk = TRUE
# opt$long = TRUE
...
path_gc_seg <- paste0(path_ref, "gc.seg")
path_map_seg <- paste0(path_ref, "map.seg")
...
if (!create_bulk) {
  ...
  mclapply(files,process_cells, mc.cores = 10)
} else {
  i = 1
  for (cell in files) {
    split <- strsplit(cell, "/")[[1]]
